...
import Simplex.Chat.Operators.Presets (operatorSimpleXChat, simplexChatRelays, simplexChatSMPServers, whisperXFTPServers)
...
terminalChatConfig =
  defaultChatConfig
    { presetServers =
      ...
      deviceNameForRemote = "Whisper CLI"
    }
