...
simplexTeamContactProfile =
  Profile
    { displayName = "Whisper Support",
      fullName = "",
      shortDescr = Just "Send questions about Whisper app and your suggestions",
...
simplexStatusContactProfile =
  Profile
    { displayName = "Whisper Status",
      fullName = "",
      shortDescr = Just "Automatic Whisper server status and app release updates",
