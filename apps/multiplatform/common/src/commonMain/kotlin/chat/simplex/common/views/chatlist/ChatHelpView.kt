...
import chat.simplex.common.views.usersettings.whisperSupportUri
...
fun ChatHelpView(addContact: (() -> Unit)? = null) {
  Column(
    ...
    ReadableTextWithLink(MR.strings.you_can_connect_to_simplex_chat_founder, whisperSupportUri)
    Column(
